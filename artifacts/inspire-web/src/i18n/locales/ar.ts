export const ar = {
  ...
  assessment: {
    ...
    payment: {
      ...
      titleNew: "ابدأ تقييمك الكامل",
      titleRetry: "ارجع لتقييمك السابق وطور نتيجتك",
      subtitleNew:
        "افتح التحليل الكامل المكوّن من 21 سؤالاً، وولّد ملف تشغيل شخصي للذكاء الاصطناعي جاهزاً للاستخدام مع أي مساعد.",
      subtitleRetry:
        "أنشئ تقييماً محسّناً مرتبطاً بنتيجتك السابقة، مع مقارنة أوضح ومخرجات أعمق.",
      sidebarTitle: "ماذا ستحصل عليه",
      sidebarText:
        "المسار الكامل يبقي الدفع والأسئلة والتحليل وتوليد التقرير داخل رحلة INSPIRE واحدة وواضحة.",
      ...
      freeActivate: "ابدأ التقييم الكامل مجاناً",
      freeActivateRetry: "ابدأ إعادة التقييم مجاناً",
