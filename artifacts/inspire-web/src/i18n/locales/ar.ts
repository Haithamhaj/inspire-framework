  ...
  landing: {
    hero: {
      ...
      compare: {
        ...
        promptText:
          "ساعدني أرتب أفكاري: ما أول شيء أبدأ به؟ ما أهم شيء أنتبه له؟ وما هي الخطوات الثلاث القادمة؟",
        withoutLabel: "بدون ملف تشغيل",
        withoutTag: "رد عام",
        withoutExample:
          "ابدأ بتحديد المشكلة، ثم اعرف أنواع المستخدمين، وابنِ نموذجاً أولياً بسيطاً. ركّز على فهم المستخدم وتخصيص النتائج.",
        withoutNote: "أقل ارتباطًا بهدفك وسياقك",
        withLabel: "مع ملف تشغيل INSPIRE",
        withTag: "رد مخصّص",
        withExample:
          "لا تبدأ بالواجهة ولا الأسئلة. ابدأ بالوعد الأساسي: ماذا سيحصل الشخص بعد الإجابة ويشعر أنه يستحق الاستخدام؟ لا تبيع Prompt؛ بيع فهماً شخصياً قابلاً للاستخدام.",
        withChip1: "سياقي",
