          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  dir="ltr"
                  className="input-ltr w-full bg-background border-2 border-border rounded-xl py-3 pl-12 pr-12 text-foreground focus:outline-none focus:border-accent focus:ring-4 focus:ring-accent/10 transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
              ...
              <p className="text-xs text-muted-foreground mt-1.5">8 أحرف على الأقل، حرف ورقم واحد على الأقل</p>
            </div>
            ...
            <div>
              ...
              {errors.confirmPassword && (
                <p className="text-destructive text-sm mt-1.5 font-medium">{errors.confirmPassword.message}</p>
              )}
            </div>
            ...
            <div>
              <label className="block text-sm font-bold text-foreground mb-2">
                المسمى الوظيفي <span className="text-muted-foreground font-normal text-xs">(اختياري)</span>
              </label>
              <div className="relative">
