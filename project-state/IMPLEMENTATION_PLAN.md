...
- [x] Add first SEO trust/entity pages:
  - `/about`
  - `/research`
  - `/contact`
...
- [x] Clarify in review-facing pages that INSPIRE is a premade self-serve digital product, not consultation or custom-service sales.
