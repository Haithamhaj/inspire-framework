export const ar = {
  ...
  assessment: {
    ...
    payment: {
      ...
      titleNew: "أكمل الدفع لإنشاء تقريرك",
      titleRetry: "أكمل الدفع لإنشاء تقييم جديد",
      subtitleNew:
        "تم حفظ إجاباتك. أكمل الدفع الآن لبدء التحليل وتوليد ملف تشغيل شخصي للذكاء الاصطناعي جاهز للاستخدام.",
      subtitleRetry:
        "تم تجهيز إجابات إعادة التقييم. أكمل الدفع لتوليد تقرير جديد مرتبط بنتيجتك السابقة.",
      ...
      oneTime: "دفعة واحدة",
      noSubscription: "بدون اشتراك · تقرير PDF والمشاركة مشمولان",
      ...
      previewBehaviorTitle: "نمطك التشغيلي",
      previewBehaviorText:
      ...
      previewStrengthsTitle: "نقاط القوة",
      previewStrengths: "التحليل المعمّق\nالتخطيط الاستراتيجي\nوضوح التنفيذ",
      previewGrowthTitle: "مناطق التطوير",
      previewGrowth: "الاستجابة السريعة\nالمرونة في التغيير\nتقليل التردد",
      previewOverlayTitle: "ادفع مرة واحدة واحصل على الملف الكامل",
    ...
    status: {
      ...
      processingProgressLabel: "تقدّم التحليل",
      processingAsideTitle: "ماذا يحدث الآن",
      processingAsideDescription:
        "INSPIRE يحوّل إجاباتك إلى ملف تشغيل عملي لأدوات الذكاء الاصطناعي.",
      processingStepAnswersTitle: "قراءة إجاباتك",
      processingStepAnswersDescription:
        "نرتّب اختياراتك والسياق المفتوح قبل بدء التحليل.",
      ...
      processingStepInstructionsDescription:
        "يتم تحويل ملفك إلى توجيهات قابلة للاستخدام في ChatGPT وGemini وClaude.",
    ...
    wizard: {
      ...
      projectContextPlaceholder:
        "مثال: أبني أداة لتحليل سلوك المستخدمين. اسم المشروع: INSPIRE",
  ...
  privacyConsent: {
    ...
    analysisTitle: "تحليل النمط:",
    analysisText: "يتم استخدام إجاباتك لإنشاء تقرير دقيق يعكس أسلوبك في العمل والتواصل.",
  ...
  results: {
    ...
    mini: {
      ...
      upgradeTitle: "احصل على ملف التشغيل الكامل",
      upgradeDescription:
        "التقييم الكامل يحلل ملفك بعمق ويولّد تعليمات نظام شخصية كاملة، تقرير PDF، ونتائج قابلة للمشاركة.",
  ...
  landing: {
    ...
    axes: {
      eyebrow: "المكونات السبعة",
      titleSuffix: "— سبعة مكونات تُشكّل ملف تشغيل AI الخاص بك",
      subtitle:
        "كل حرف يُمثّل مكوّناً في ملفك يقرأه النظام ليبني خريطة تفاعلك مع AI",
      items: {
        intention: {
          name: "الهدف",
          desc: "ما الذي يقودك حقاً؟ هل أنت موجّه بالنتائج أم بالعملية؟ هذا المكوّن يكشف دافعك الداخلي الحقيقي.",
        },
        narrative: {
          name: "الرواية",
    ...
    sample: {
      ...
      features: [
        { title: "خريطة عملية للملف", desc: "خريطة واضحة لكيفية عمل AI معك عبر مكونات INSPIRE السبعة" },
      ...
      steps: [
        {
          ...
          desc: "إجاباتك تكشف إشارات عملية عن هدفك، أسلوبك، وطريقة تفاعلك مع AI",
        },
        {
          n: "٢",
          title: "حلّل INSPIRE نمطك",
          desc: "7 مكونات تُقرأ بدقة وتُبنى بصمتك الفريدة في خريطة تفاعل شاملة مع AI",
        },
        {
          n: "٣",
    ...
    pricing: {
      ...
      free: {
        ...
        features: [
          ...
          "3 نقاط انطلاق فورية للذكاء الاصطناعي",
          "لمحة أولية عن طريقة تعاملك مع الذكاء الاصطناعي",
          "بدون بطاقة ائتمان",
        ],
      },
      paid: {
      ...
      items: [
        {
          ...
          a: "INSPIRE هو نظام ملف تشغيل AI من 7 مكونات (الهدف، الرواية، الأسلوب، التفضيلات، التفاعل، التأمل، التقييم) صُمِّم ليساعد AI على العمل معك بشكل أفضل وفق هدفك وأسلوبك. بدلاً من استخدام AI بشكل عام، يبني INSPIRE خريطة تفاعل مخصصة لطبيعتك.",
        },
        {
          q: "كم من الوقت يستغرق التقييم الكامل؟",
          a: "التقييم الكامل يستغرق ما بين 15 و20 دقيقة، وتكشف إجاباتك على أسئلة سلوكية وسيناريوهات تفاعلية إشارات عملية عن هدفك وأسلوبك وطريقة تفاعلك مع AI. النسخة السريعة تستغرق 5 دقائق فقط وتُولّد نقاط انطلاق فورية.",
        },
        {
          q: "ما الذي يُولّده التقييم بالضبط؟",
          a: "يُولّد التقييم الكامل: خريطة عملية لملف INSPIRE عبر المكونات السبعة، تحليل دورك المهني، الخطوط الحمراء في التعامل مع AI، نقاط قوتك السلوكية، مجالات التطوير، توصيات عملية، تعليمات نظام شاملة يمكن نسخها إلى ChatGPT أو Claude، ونقاط انطلاق جاهزة.",
        },
        {
        ...
        },
        {
          ...
          a: "التقييم السريع يُركّز على 5 أبعاد من تفاعلك مع AI ويُولّد نقاط انطلاق فورية في 5 دقائق مجاناً. التقييم الكامل يقرأ 7 مكونات في ملفك بعمق ويُولّد تعليمات نظام شاملة مع تقرير مفصّل.",
        },
      ],
    },
    finalCta: {
      badge: "التقييم الكامل — 21 سؤالاً",
